Write a Python program to Count the number of nodes present in an existing BST and display the  highest element present in the BST. 
...
class BST:
    ...
    def display(self):
        ...
        max_element = self.find_max(self.root)
        print(f"Total number of nodes in BST: {node_count}")
